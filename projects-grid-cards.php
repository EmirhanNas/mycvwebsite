            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img class="card-img-top scale-on-hover" src="assets/img/nature/Adsız.png" alt="Card Image"></a>
                            <div class="card-body">
                                <h6><a href="#">Vadiakademiegitim</a></h6>
                                <p class="text-muted card-text">Danışmanlık sitesi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img class="card-img-top scale-on-hover" src="assets/img/nature/Adsız1.png" alt="Card Image"></a>
                            <div class="card-body">
                                <h6><a href="#">Emozay</a></h6>
                                <p class="text-muted card-text">E-ticaret sitesi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img class="card-img-top scale-on-hover" src="assets/img/nature/Adsız2.png" alt="Card Image"></a>
                            <div class="card-body">
                                <h6><a href="#">Andata Global</a></h6>
                                <p class="text-muted card-text">Anket sitesi.</p>
                            </div>
                        </div>
                    </div>
                </div>
